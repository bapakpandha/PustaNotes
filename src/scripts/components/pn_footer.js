...
class pn_footer extends HTMLElement {
    ...
    adtFunct() {    
        ...
        function globalStyle() {
            Utils.AddContainerStyle(self._shadowRoot);
            Utils.AddFontStyle(self._shadowRoot);
            Utils.AddAnimationStyle(self._shadowRoot);
            Utils.AddGlobalStyle(self._shadowRoot);
            self._style.textContent = self.adtFunct().getStyle();
            self._footerElement.appendChild(self._style);
            Utils.checkWindowWidth(self._shadowRoot);

        }
        return {getFooter:getFooter, getStyle:getStyle,globalStyle:globalStyle,handleResize:handleResize}
    }
}
