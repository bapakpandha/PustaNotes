  ...
  adtFunc() {
    ...
    function updateStyle() {
      self._style.textContent = `
            ...
            @media screen and (min-width: 1200px) and (max-width: 1400px){header .navbar {width:90%;}}
      ...
      window.addEventListener("scroll", function () {
        if (window.pageYOffset > 99) {
          ...
          if (
            ...
            !header.classList.contains("full") &&
    ...
    return {
      ...
      menuNavbarMobileHandler: menuNavbarMobileHandler,
      scrollHeaderSticky: scrollHeaderSticky,
